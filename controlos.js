class ControlosScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(400, 150, 'FUTBATTLE', { fill: '#000000', fontSize: '32px' }).setOrigin(0.5);

        this.add.text(400, 200, 'Este jogo é uma batalha intensa!', { fill: '#000000', fontSize: '24px' }).setOrigin(0.5);
        this.add.text(400, 250, 'Cuidado com as escolhas que faz!', { fill: '#000000', fontSize: '24px' }).setOrigin(0.5);
